...
link-citations: yes
description: "This is a codebook that documents all of the items in the current version of the HBN Pediatric Screener Applet for Mindlogger."
---
...
dataPath <- getURL("https://raw.githubusercontent.com/minji5924/HBN_PMHS/master/ENG_Peds_Screen_data_dic.csv")

dataDic <- read_csv(dataPath)

dataDic[1,18] = 8

# dataDic = read_csv("ENG_Peds_Screen_data_dic.csv")
# 
# dataDic[1,18] = 8
...
imagePath <- 'https://raw.githubusercontent.com/minji5924/HBN_PMHS/master/images/'
...
parseResponse <- function(dataset, question_name) {
 ...
 #temporary fix, revert later
  ...
  if (choiceType %in% c('time', 'timeRange')) {
    ...
    return("**Responses**: _This item is a text input_")
  }
...
---
title: "`r paste0('Applet Codebook: HBN Pediatric Screener for Mindlogger ', dataDic$version[[1]])`"
---
